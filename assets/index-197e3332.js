...
function AppContextProvider(props) {
  const [allPhotos, setAllPhotos] = reactExports.useState([]);
  const [cartItems, setCartItems] = reactExports.useState([]);
  reactExports.useEffect(() => {
    fetch(
      "https://raw.githubusercontent.com/bobziroll/scrimba-react-bootcamp-images/master/images.json"
    ).then((response) => response.json()).then((data) => setAllPhotos(data));
  }, []);
  function toggleFavorite(num) {
    const newArray = [];
    allPhotos.forEach(
      (obj) => +obj.id !== +num ? newArray.push(obj) : newArray.push({ ...obj, isFavorite: !obj.isFavorite })
    );
...
function Header() {
  const { cartItems } = reactExports.useContext(AppContext);
  return /* @__PURE__ */ jsxs("header", { children: [
    /* @__PURE__ */ jsx("h2", { children: /* @__PURE__ */ jsx(Link, { to: "/pic-some/", children: "Pic Some" }) }),
    /* @__PURE__ */ jsx(Link, { to: "/pic-some/cart", children: /* @__PURE__ */ jsx(
      "i",
      {
...
var Icon = function(e) {
  ...
  var u2 = function() {
    ...
    return r3;
  }, f2 = 0, d = n2.forwardRef(function(e2, t3) {
    var r3 = e2.path, o2 = e2.id, l3 = void 0 === o2 ? ++f2 : o2, i2 = e2.title, a2 = void 0 === i2 ? null : i2, s2 = e2.description, c2 = void 0 === s2 ? null : s2, d2 = e2.size, y2 = void 0 === d2 ? null : d2, v2 = e2.color, b = void 0 === v2 ? "currentColor" : v2, m2 = e2.horizontal, h = void 0 !== m2 && m2, g = e2.vertical, O2 = void 0 !== g && g, w2 = e2.rotate, j = void 0 === w2 ? 0 : w2, z2 = e2.spin, E2 = void 0 !== z2 && z2, P2 = e2.style, S2 = void 0 === P2 ? {} : P2, x2 = e2.inStack, _ = void 0 !== x2 && x2, k2 = p2(e2, ["path", "id", "title", "description", "size", "color", "horizontal", "vertical", "rotate", "spin", "style", "inStack"]), T2 = {}, q2 = [];
    ...
    var M2 = n2.createElement("path", u2({ d: r3, style: T2 }, _ ? k2 : {})), C2 = M2;
...
function Image({ className, img }) {
  const [hovered, ref] = useHover();
  const { toggleFavorite, addToCart, removeFromCart, cartItems } = reactExports.useContext(AppContext);
  function heartIcon() {
    if (img.isFavorite) {
      return /* @__PURE__ */ jsx(
        Icon,
  ...
  return /* @__PURE__ */ jsxs("div", { className: `${className} image-container`, ref, children: [
    /* @__PURE__ */ jsx("img", { src: img.url, className: "image-grid" }),
    heartIcon(),
    cartIcon()
  ] });
}
...
function Photos() {
  const { allPhotos } = reactExports.useContext(AppContext);
  const photos = allPhotos.map((obj, i) => /* @__PURE__ */ jsx(Image, { img: obj, className: getClass(i) }, obj.id));
  return /* @__PURE__ */ jsx("main", { className: "photos", children: photos });
}
function App() {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(Header, {}),
    /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsx(Route, { path: "/pic-some/", element: /* @__PURE__ */ jsx(Photos, {}) }),
      /* @__PURE__ */ jsx(Route, { path: "/pic-some/cart", element: /* @__PURE__ */ jsx(Cart, {}) })
    ] }),
    ";"
  ] });
}
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsx(React.StrictMode, { children: /* @__PURE__ */ jsx(AppContextProvider, { children: /* @__PURE__ */ jsx(BrowserRouter, { children: /* @__PURE__ */ jsx(App, {}) }) }) })
);
